...
(define-key emmet-mode-keymap (kbd "C-,") 'emmet-expand-line) ;; C-j で展開
          ...
          '(lambda ()
             ...
             (define-abbrev-table
               ...
               '(
                 ...
                 ("olid" "order_line_id" nil)
                 ("oss" "ORDR_STATUS" nil)
                 ("ssid" "status_id" nil)
                 ("ssname" "status_name" nil)
                 ("ose" "ORDR_STATE" nil)
                 ("seid" "state_id" nil)
                 ("sename" "state_name" nil)
                 ("ot" "ORDR_TRANS" nil)
                 ("tid" "trans_id" nil)
                 ("ttxt" "trans_txt" nil)
                 ("ohid" "order_header_id" nil)
                 ...
                 ("ofcd" "offr_cd" nil)
                 ("ofid" "offr_id" nil)
                 ("pco" "PROD_CTLG_OFFR" nil)
                 ("coid" "ctlg_offr_id" nil)
                 ("ps" "PROD_SPEC" nil)
                 ("spid" "spec_id" nil)
                 ("spcd" "spec_cd" nil)))
